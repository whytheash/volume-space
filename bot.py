...
user_data = {}
start_message = "привет татуер! на связи волюм! мы проделали большой путь вместе с командой, чтобы в итоговом счете этот тест дошел до тебя, надеемся он тебе понравится и окажется полезным его прохождение, а может даже вдохновит на что-то новое! результаты могут помочь понять в каком направлении развиваться, даже если сейчас ты новичок. " \
